...
// Owner information
global.Owner = process.env.OWNER ? process.env.OWNER.split(",") : ["94781306128"];
global.OwnerNumber = process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.split(",") : ["9478106128"];
global.ownertag = process.env.OWNER_TAG ? process.env.OWNER_TAG.split(",") : ["94781306128"];
global.OwnerName = process.env.OWNER_NAME || "dinuth";
